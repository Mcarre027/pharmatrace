    ...
    dbc.Row([
        dbc.Col([
            ...
            html.P("""
                ...
                Les tranches plus jeunes, comme 0-18 ans et 19-35 ans, présentent un nombre de cas nettement inférieur (38 et 67 cas respectivement), ce qui peut refléter à la fois une moindre couverture vaccinale initiale, une meilleure tolérance aux vaccins ou encore une sous-déclaration des effets secondaires dans ces populations.
    ...
    dbc.Row([
        dbc.Col([
            ...
            html.P("""
                ...
                Les effets secondaires comme le malaise, la fatigue, la nausée et les maux de tête apparaissent également de manière significative, avec des fréquences proches les unes des autres (autour de 50 cas). En revanche, des symptômes comme l’éruption cutanée (Rash) ou des syndromes pseudo-grippaux (Influenza) sont moins souvent rapportés dans cette population.
